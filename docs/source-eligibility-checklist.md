...
Use `scripts/source_owner_review_decision.py --draft <source_id>` to create an ignored owner-decision draft, and `scripts/source_owner_review_decision.py --validate <path>` before applying a completed decision to tracked artifacts.
