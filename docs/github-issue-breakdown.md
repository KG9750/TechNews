...
Issues #10, #11, #12, #13, #14, and #15 are implemented and closed by PRs #24, #26, #28, #30, #32, and #34. Issues #16 through #19 remain `ready-for-agent`; issue #20 remains `needs-triage` until core MVP implementation completes.
