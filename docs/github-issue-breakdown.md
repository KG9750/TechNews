...
Issues #10, #11, #12, #13, and #14 are implemented and closed by PRs #24, #26, #28, #30, and #32. Issues #15 through #19 remain `ready-for-agent`; issue #20 remains `needs-triage` until core MVP implementation completes.
