...
- `scripts/source_owner_review_decision.py` can list open source reviews, draft ignored owner-decision files, and validate completed decisions before tracked policy artifacts are changed.
