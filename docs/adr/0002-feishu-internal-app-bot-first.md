...
- MVP implementation issues must not be marked `ready-for-agent` until live internal-app user and group delivery evidence passes.
- If the live delivery spike proves the internal app bot cannot satisfy both recipient types, supersede this ADR before MVP implementation.
